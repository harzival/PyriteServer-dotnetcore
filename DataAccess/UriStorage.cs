...
namespace UniscanServer.DataAccess
{
    ...
    public class UriStorage : ICubeStorage, IDisposable
    {
        ...
        private static class LKGSerializer
        {
            ...
            {
                LKGSerializer.filename = Path.Combine(Path.GetTempPath(), "UniscanServer_lkg.gzip");
            ...
            public static bool TrySave(LoaderResults results)
            {
                ...
                {
                    System.ArgumentException argEx = new System.ArgumentException("Failed to serialize results/writer", ex);
                    throw argEx;
                }
